...
vim.api.nvim_set_keymap('n', '<leader>wm', ':wincmd |<CR>', { noremap = true, silent = true, desc = 'Maximize current vertical split' })

-- Restore all splits to equal size
vim.api.nvim_set_keymap('n', '<leader>we', ':wincmd =<CR>', { noremap = true, silent = true, desc = 'Restore all splits to equal size' })
